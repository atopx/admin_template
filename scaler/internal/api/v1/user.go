...
import (
	...
	"scaler/internal/controller/user/user_create"
	"scaler/internal/controller/user/user_delete"
	"scaler/internal/controller/user/user_disable"
	"scaler/internal/controller/user/user_info"
	"scaler/internal/controller/user/user_list"
	"scaler/internal/controller/user/user_login"
	"scaler/internal/controller/user/user_refresh"
	"scaler/internal/controller/user/user_update"
